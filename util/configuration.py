...
class Configuration():
    def parse(self, unknown_arg_ok=False):
        ...
        parser.add_argument('--use_IS', action='store_true')
        ...
        parser.add_argument('--ovis_root', help='DAVIS data root', default='../OVIS')
        parser.add_argument('--num_workers', help='Total number of dataloader workers across all GPUs processes', type=int, default=8)
        ...
        # Stage 4, OVIS, shorter
        parser.add_argument('--s4_batch_size', default=8, type=int)
        parser.add_argument('--s4_iterations', default=30000, type=int)
        # fine-tune means fewer augmentations to train the sensory memory
        parser.add_argument('--s4_finetune', default=3000, type=int)
        parser.add_argument('--s4_steps', nargs="*", default=[24000], type=int)
        ...
        parser.add_argument('--s4_start_warm', default=6000, type=int)
        parser.add_argument('--s4_end_warm', default=21000, type=int)
        ...
        # parser.add_argument('--load_network_IS', help='Path to pretrained network weight only')
        parser.add_argument('--load_checkpoint', help='Path to the checkpoint file, including network, optimizer and such')
        # parser.add_argument('--load_checkpoint_IS', help='Path to the checkpoint file, including network, optimizer and such')

        # Logging information
        parser.add_argument('--log_text_interval', default=100, type=int)
        parser.add_argument('--log_image_interval', default=1000, type=int)
        parser.add_argument('--save_network_interval', default=7500, type=int)
